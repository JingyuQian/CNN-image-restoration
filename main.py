...
from nn import LogisticRegression, HiddenLayer, LeNetConvPoolLayer, DropoutHiddenLayer, drop, LeNetConvLayer, \
    LeNetPoolLayer, bn_layer, upsampling, train_nn
...
def test_lenet_rotation(learning_rate=0.1, n_epochs=200,
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            cost_ij = train_model(
                rotate_image(train_set_x[minibatch_index * batch_size: (minibatch_index + 1) * batch_size]).astype(
                    numpy.float32),
...
# Problem 2.4
# Write a function to add noise, it should at least provide Gaussian-distributed and uniform-distributed noise
# with zero mean
